...
# frequently, and the usual fix is simply updating yt-dlp. Skip with KAGECLIP_NO_UPDATE=1.
if [ -z "$KAGECLIP_NO_UPDATE" ]; then
...
echo ""
echo "  KageClip is running at http://localhost:$PORT"
echo ""
python3 app.py
